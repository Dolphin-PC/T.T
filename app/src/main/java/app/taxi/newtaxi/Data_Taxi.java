...
public class Data_Taxi {
    ...
    private int pay, pay_complete, service_each, person;
    private boolean complete_driver, complete_client,complete_ride;

    public Data_Taxi() {
    }

    public Data_Taxi(String email, String driver, String taxiphonenumber, String taxinumber, int pay, int pay_complete, int service_each, boolean complete_driver, boolean complete_client,boolean complete_ride, int person) {
        this.email = email;
        this.driver = driver;
