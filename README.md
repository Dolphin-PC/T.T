...
> 도시 특성상 '택시'외에는 교통수단이 없는 지역민을 대상으로, 개인 차량이 없는 학생, 교통약자들을 위한 택시비의 부담을 줄여주기 위한 **"택시 동승 서비스"** 입니다.
...
### 수상이력
 #### 2018 한림SW해커톤 우수상
 <img src="한림대학교 해커톤 상장.png" width="30%">

 #### 2019 한림 Spin-Off 창업팀 선정

 #### 2019 교육부 학생창업유망팀 300 선정
 <img src="창업유망팀 300 인증서.png" width="30%">
